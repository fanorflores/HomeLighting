...
if ($apiClient->login()) {
    $gcdata = $apiClient->listProducts();
} else {
    echo "Error al conectar a la API de Grupo Cubas ";
}
                                        ...
                                        <li class="nav-item dropdown ">
                                            ...
                                            <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                <a class="dropdown-item list-group-item" data-bs-toggle="tab"
                                                    data-bs-target="#table_hl" role="tab">Todos los productos</a>
                                                <a class="dropdown-item list-group-item" data-bs-toggle="tab"
                                                    data-bs-target="#table_2" role="tab">Solo en Línea </a>
                                                <a class="dropdown-item list-group-item" data-bs-toggle="tab"
                                                    data-bs-target="#table_hl" role="tab">Solo en GC</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="table_hl" role="tabpanel"
                                        aria-labelledby="table_hl">
                                        <!-- NFTMax Table -->
                                                        ...
                                                        <td class="nftmax-table__column-1 nftmax-table__data-1">
                                                            <div class="nftmax-table__product">
                                                                <div class="nftmax-table__product-img">
                                                                    <img src="img/img-products-default.png" alt="#">
                                                                </div>
                                                            </div>
                                                        </td>
